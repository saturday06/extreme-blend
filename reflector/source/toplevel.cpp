...
static void destroy_toplevel(wl_resource *resource) {
  auto toplevel = static_cast<Toplevel *>(wl_resource_get_user_data(resource));
  delete toplevel;
}
...
void Toplevel::set_app_id(wl_client *client, wl_resource *resource,
                          const char *app_id) {
...
void Toplevel::resize(wl_client *client, wl_resource *resource,
                      wl_resource *seat, uint32_t serial, uint32_t edges) {
  fprintf(stderr, "Toplevel::resize not implemented\n");
}

void Toplevel::set_max_size(wl_client *client, wl_resource *resource,
                            int32_t width, int32_t height) {
  fprintf(stderr, "Toplevel::set_max_size not implemented\n");
}

void Toplevel::set_min_size(wl_client *client, wl_resource *resource,
                            int32_t width, int32_t height) {

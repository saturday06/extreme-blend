...
static struct zxdg_shell_v6_interface shell_interface = {
    &ZxdgShellV6::destroy, &ZxdgShellV6::create_positioner,
    &ZxdgShellV6::get_xdg_surface, &ZxdgShellV6::pong};

ZxdgShellV6::ZxdgShellV6(wl_display *display) : display_(display) {
...
void ZxdgShellV6::pong(wl_client *client, wl_resource *resource,
                       uint32_t serial) {
  fprintf(stderr, "ZxdgShellV6::create_positioner not implemented\n");
}
